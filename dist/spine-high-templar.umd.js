(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined'
        ? factory(exports, require('mitt'), require('uuid/v1'))
        : typeof define === 'function' && define.amd
        ? define(['exports', 'mitt', 'uuid/v1'], factory)
        : factory(
              (global.spineHighTemplar = global.spineHighTemplar || {}),
              global.mitt,
              global.uuid
          );
})(this, function(exports, mitt, uuid) {
    'use strict';
        ...
        createClass(Socket, [
            {
                ...
                value: function initialize(props) {
                    ...
                    ['pingInterval', 'reconnectInterval'].forEach(function(
                        propName
                    ) {
            ...
            },
            {
                ...
                value: function on() {
                    ...
                    return (_events = this._events).on.apply(
                        _events,
                        arguments
                    );
                },
            },
            {
                ...
                value: function off() {
                    ...
                    return (_events2 = this._events).off.apply(
                        _events2,
                        arguments
                    );
                },
